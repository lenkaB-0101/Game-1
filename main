...
if __name__ == "__main__":
    ...
    ship_coordinates_y = 680

    meteor_coordinates_x = 200
    meteor_coordinates_y = 10
    ...
    while True:
        ...
        if check_colision(ship_mask, meteor['mask'],
                          (ship_coordinates_x, ship_coordinates_y), (meteor['x'], meteor['y'])):
            end = True
